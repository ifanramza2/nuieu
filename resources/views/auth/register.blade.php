<form class="register" role="form" method="POST" action="{{ route('register') }}">
    ...
    <div class="row">
        ...
        <div class="form-group{{ old('tab') == 'register' && $errors->has('role') ? ' has-error' : '' }} col-md-12">
            <label for="role" class="control-label">Role </label>

            <div class="dropdown">
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-briefcase"></i> </span>
                      <select id="role" class="form-control" name="role" placeholder="Select Your Role">
...
<!--                    <input id="username" type="text" class="form-control" placeholder="example" name="username" value="{{ old('username') }}" required>-->
                ...
                @if (old('tab') == 'register' && $errors->has('role'))
                    <span class="help-block">
