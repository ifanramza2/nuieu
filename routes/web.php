...
// Event
Route::get('/{username}/events', 'EventController@index');
Route::get('/{username}/events/create', 'EventController@create');
Route::post('/{username}/save/event', 'EventController@store');
