<div class="profile-information">
    ...
    @if ($user->role === 'Artist')
        <ul class="list-group">
            ...
            <li class="list-group-item">
                ...
                {{ $user->birthday->format('d.m.Y') }} - ( {{ $user->getAge() }} years )
            </li>
            @endif
            @if ($user->bio)
            <li class="list-group-item">
    ...
    @else
        <ul class="list-group">
            ...
            <li class="list-group-item">
                <i class="fa fa-birthday-cake"></i>
                Established since {{ $user->birthday->format('d.m.Y') }}
            </li>
            @endif
            @if ($user->bio)
            <li class="list-group-item">
...
<div class="panel panel-default">
    <div class="panel-heading">Main Interest @if($my_profile) <a href="javascript:;" data-toggle="modal" data-target="#profileHobbies"><i>{{ 'Edit' }}</i></a> @endif</div>

    <ul class="list-group" style="max-height: 300px; overflow-x: auto">
        @if($user->hobbies()->count() == 0)
            <li class="list-group-item">No interest</li>
        @else
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title">Your Main Interest</h5>
            </div>
